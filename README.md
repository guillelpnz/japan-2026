# Japón · noviembre de 2026

Guía estática para un viaje de 14 días y 13 noches, del 4 al 17 de noviembre, con un grupo de 10.

El contenido, los estilos y el JavaScript están en `index.html`; no requiere compilación ni instalación de dependencias. `.nojekyll` permite servirlo directamente en GitHub Pages.
